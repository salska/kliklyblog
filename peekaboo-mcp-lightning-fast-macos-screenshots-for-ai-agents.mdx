export const meta = {
  slug: "peekaboo-mcp-lightning-fast-macos-screenshots-for-ai-agents",
  ...
  tags: ["MCP", "Claude", "Swift", "macOS", "Screenshots", "Developer Tools"],
};

<img
  src="/assets/img/2025/peekaboo-mcp-lightning-fast-macos-screenshots-for-ai-agents/banner.png"
  alt=""
  loading="lazy"
