export const meta = {
  slug: "when-ai-meets-madness-peters-16-hour-days",
  ...
  tags: ["AI", "Claude", "Development", "Productivity", "Philosophy"],
};

<img
  src="/assets/img/2025/when-ai-meets-madness-peters-16-hour-days/header.png"
  alt=""
  loading="lazy"
