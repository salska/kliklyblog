export const meta = {
  slug: "applescript-cli-macos-complete-guide",
  ...
  tags: ["macOS", "Development", "AppleScript", "CLI", "Swift", "Security", "MCP", "AI", "Cursor"],
};

<img
  src="/assets/img/2025/applescript-cli-macos-complete-guide/header.png"
  alt=""
  loading="lazy"
