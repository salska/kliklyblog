export const meta = {
  slug: "showing-settings-from-macos-menu-bar-items",
  ...
  tags: ["macOS", "SwiftUI", "MenuBarExtra", "Settings"],
};

<img
  src="/assets/img/2025/showing-settings-from-macos-menu-bar-items/hero.png"
  alt=""
  loading="lazy"
