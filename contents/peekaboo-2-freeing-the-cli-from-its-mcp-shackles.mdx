export const meta = {
  slug: "peekaboo-2-freeing-the-cli-from-its-mcp-shackles",
  ...
  tags: ["MCP", "CLI", "Swift", "macOS", "Screenshots", "Developer Tools", "AI Agents"],
};

<img
  src="/assets/img/2025/peekaboo-2-freeing-the-cli-from-its-mcp-shackles/banner.png"
  alt=""
  loading="lazy"
