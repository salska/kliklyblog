export const meta = {
  slug: "claude-code-is-my-computer",
  ...
  tags: ["AI", "Claude", "Computing", "Development", "Productivity", "Claude-Code", "DevOps", "Automation"],
};

<img
  src="/assets/img/2025/claude-code-is-my-computer/hero.png"
  alt=""
  loading="lazy"
