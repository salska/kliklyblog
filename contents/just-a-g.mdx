export const meta = {
  slug: 'just-a-g',
  title: 'The importance of being a G',
  description: 'A practical guide to working with AI coding agents without the hype.',
  pubDatetime: '2025-10-23T10:00:00+01:00',
  heroImage: '/assets/img/2025/Just a G/file-20251023175331345.png',
  tags: ['ai', 'claude', 'engineering', 'productivity'],
};

<img
  src="/assets/img/2025/Just a G/file-20251023175331345.png"
  alt=""
  loading="lazy"
  className="mb-8 aspect-video w-full rounded-md object-cover"
/>

I've been ever so incredibly quiet lately as I'm knee-deep working on my latest project. Agentic engineering has become so good that it now writes pretty much 100% of my code. And yet I see so many folks trying to solve issues and generating these elaborated charades instead of getting sh*t done.
