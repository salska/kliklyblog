export const meta = {
  slug: "migrating-700-tests-to-swift-testing",
  ...
  tags: ["Swift", "Testing", "Swift-Testing", "XCTest", "AI", "Migration", "iOS", "macOS"],
};

<img
  src="/assets/img/2025/migrating-700-tests-to-swift-testing/hero.png"
  alt=""
  loading="lazy"
