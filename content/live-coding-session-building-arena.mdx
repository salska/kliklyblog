export const meta = {
  slug: "live-coding-session-building-arena",
...
<img
  src="/assets/img/2025/live-coding-session-building-arena/hero.png"
  alt=""
  loading="lazy"
...
[Watch the live coding session on YouTube](https://www.youtube.com/watch?v=68BS5GCRcBo)
