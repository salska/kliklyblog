export const meta = {
  slug: "vibe-meter-2-claude-code-usage-calculation",
  ...
  tags: ["Swift", "Claude", "AI", "Development", "Tools"],
};

<img
  src="/assets/img/2025/vibe-meter-2-claude-code-usage-calculation/header.png"
  alt=""
  loading="lazy"
