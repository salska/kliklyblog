export const meta = {
  slug: "vibetunnel-turn-any-browser-into-your-mac-terminal",
  ...
  tags: ["Terminal", "Web Development", "Rust", "Claude Code", "Open Source", "Hackathon"],
};

<img
  src="/assets/img/2025/vibetunnel/hero.jpg"
  alt=""
  loading="lazy"
