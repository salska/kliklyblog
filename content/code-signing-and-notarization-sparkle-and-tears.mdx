export const meta = {
  slug: "code-signing-and-notarization-sparkle-and-tears",
  ...
  tags: ["macOS", "Development", "Code Signing", "Sparkle", "Notarization", "Swift"],
};

<img
  src="/assets/img/2025/code-signing-and-notarization-sparkle-and-tears/header.png"
  alt=""
  loading="lazy"
