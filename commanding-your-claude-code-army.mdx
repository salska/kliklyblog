export const meta = {
  slug: "commanding-your-claude-code-army",
  ...
  tags: ["AI", "Claude", "Development", "Terminal", "Productivity", "Claude-Code", "DevOps"],
};

<img
  src="/assets/img/2025/commanding-your-claude-code-army/header.png"
  alt=""
  loading="lazy"
